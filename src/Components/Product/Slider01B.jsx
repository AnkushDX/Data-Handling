  ...
  return (
    <>
        ...
        <div className={Style.reviewDiv}>
          <span><img className={Style.starImg} src="Images/starImg1.webp"/><img className={Style.starImg} src="Images/starImg1.webp"/><img className={Style.starImg} src="Images/starImg1.webp"/><img className={Style.starImg} src="Images/starImg1.webp"/><img className={Style.starImg} src="Images/starImg1.webp"/><span className={Style.review}>7 Reviews</span></span>
        </div>
