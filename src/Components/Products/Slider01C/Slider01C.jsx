...
const Slider01C = () => {
  ...
  return (
    ...
    >
      <div
        className={`accordion-item ${Style.accordionItem1} ${
          activeAccordion !== "collapseOne" ? Style.grayBackgorund : ""
        }`}
      >
        <input
          ...
          onChange={() => handleAccordionChange("collapseOne")}
        />
        <label
      ...
      <div
        className={`accordion-item ${Style.accordionItem} ${
          activeAccordion !== "collapseTwo" ? Style.grayBackgorund : ""
        }`}
      >
        <input
          className={Style.icon1}
          ...
          onChange={() => handleAccordionChange("collapseTwo")}
        />
        <label
          className={`accordion-header ${Style.accordionHeader}`}
