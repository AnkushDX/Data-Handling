...
import Style from "../ProductShop/ProductsShop.module.css"
import data from './ProductShop.json'
                ...
                <div className="container ">
                    <div className="row">
                        {data.map((product, index) => (
                            <div key={index} className={`col-lg-3 col-md-6  ${Style.colactionCart}`}>
                                ...
                                <div className={Style.iconStar}>
                                        {[...Array(5).keys()].map((i) => (
                                            <span key={i}>
                                                {i < product.rating ? (
                                                    <IoIosStar style={{ color: "#e6bf69" }} />
                                                ) : (
                                                    <IoIosStar style={{ color: "#808080" }} />
                                                )}
                                            </span>
                                        ))}
